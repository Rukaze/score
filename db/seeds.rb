...
5.times do |n|
  Stut.create( player_id: Player.find_by(name: "ben").id, game_id: "#{game_id - n}", FGmake: rand(11), FGmiss: rand(11), Deepmake: rand(7), Deepmiss: rand(7),
...
5.times do |n|
  Stut.create( player_id: Player.find_by(name: "rich").id, game_id: "#{game_id - n}", FGmake: rand(11), FGmiss: rand(11), Deepmake: rand(7), Deepmiss: rand(9),
  FTmake: rand(11), FTmiss: rand(4), DefReb: rand(11), OffReb: rand(11), Assist: rand(11), Block: rand(5), steal: rand(5),
  TO: rand(5), PF: rand(5), playingtime: 1900, player_name: "rich", team_id: team_id, point: rand(10..25))
end
5.times do |n|
  Stut.create( player_id: Player.find_by(name: "haris").id, game_id: "#{game_id - n}", FGmake: rand(11), FGmiss: rand(11), Deepmake: rand(4), Deepmiss: rand(8),
  FTmake: rand(11), FTmiss: rand(4), DefReb: rand(11), OffReb: rand(11), Assist: rand(11), Block: rand(5), steal: rand(5),
  TO: rand(5), PF: rand(5), playingtime: 2000, player_name: "haris", team_id: team_id, point: rand(8..25))
end
5.times do |n|
  Stut.create( player_id: Player.find_by(name: "hoho").id, game_id: "#{game_id - n}", FGmake: rand(11), FGmiss: rand(11), Deepmake: rand(7), Deepmiss: rand(7),
  FTmake: rand(11), FTmiss: rand(4), DefReb: rand(11), OffReb: rand(11), Assist: rand(11), Block: rand(5), steal: rand(5),
  TO: rand(5), PF: rand(5), playingtime: 2200, player_name: "hoho", team_id: team_id, point: rand(8..25))
end
5.times do |n|
  Stut.create( player_id: Player.find_by(name: "jojo").id, game_id: "#{game_id - n}", FGmake: rand(11), FGmiss: rand(11), Deepmake: rand(4), Deepmiss: rand(11),
  FTmake: rand(11), FTmiss: rand(4), DefReb: rand(11), OffReb: rand(11), Assist: rand(11), Block: rand(5), steal: rand(5),
  TO: rand(5), PF: rand(5), playingtime: 2100, player_name: "jojo", team_id: team_id, point: rand(15..25))
end
5.times do |n|
  Stut.create( player_id: Player.find_by(name: "kork").id, game_id: "#{game_id - n}", FGmake: rand(11), FGmiss: rand(11), Deepmake: rand(6), Deepmiss: rand(10),
  FTmake: rand(11), FTmiss: rand(4), DefReb: rand(11), OffReb: rand(11), Assist: rand(11), Block: rand(5), steal: rand(5),
